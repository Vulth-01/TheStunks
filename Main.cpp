...
void init() {
	...
	glEnable(GL_LIGHTING);
		...
		pointLight->setAmbient(glm::vec4(2.5f, 2.5f, 2.5f, 0.5f));
		pointLight->setSpecular(glm::vec4(0, 0, 0, 0));
		pointLight->setDiffuse(glm::vec4(0.5f, 0.5f, 0.5f, 0.5f));

		directionalLight = new Light();
		directionalLight->init();
		directionalLight->setPosition(glm::vec4(10, 2, 0, 1));
		directionalLight->setAmbient(glm::vec4(2.5f, 2.5f, 2.5f, 2.5f));
